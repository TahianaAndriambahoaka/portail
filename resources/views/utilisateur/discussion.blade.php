<?php
    ...
    if ($fonction == 'ATR') {
        $header = 'atr.header';
        $nav_gauche = 'atr.nav-gauche';
        $publier_sujet = asset('/ATR/plateforme-de-discussion/publier-sujet');
        $commenter = asset('/ATR/plateforme-de-discussion/commenter');
    } elseif ($fonction == 'GCR') {
        $header = 'gcr.header';
        $nav_gauche = 'gcr.nav-gauche';
        $publier_sujet = asset('/GCR/plateforme-de-discussion/publier-sujet');
        $commenter = asset('/GCR/plateforme-de-discussion/commenter');
    } else {
        $header = 'rls.header';
        $nav_gauche = 'rls.nav-gauche';
        $publier_sujet = asset('/RLS/plateforme-de-discussion/publier-sujet');
        $commenter = asset('/RLS/plateforme-de-discussion/commenter');
    }
?>
<!DOCTYPE html>
<html lang="en">
