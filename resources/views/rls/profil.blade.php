...
<body>
                ...
                <div class="card-body">
                  <div class="row">
                    <div style="margin-left:auto; margin-right:auto; text-align:center">
                      <form action="{{asset('/RLS/profil/changer-photo-de-profil')}}" method="POST" enctype="multipart/form-data" id="form_changer_photo_de_profil">
                        @csrf
                        ...
                        <div class="mt-2" style="font-weight: lighter">RLS (Responsable Logistique Stock)</div>
                  ...
                  <div class="row" style="margin: 3%">
                    <h3>Modification de profil</h3>
                      ...
                      @if ($message = Session::get('errorProfil'))
                        ...
                        <p class="text-center alert alert-danger animate__animated animate__bounceInRight mt-5" style="margin-left: auto; margin-right: auto">{{$message}}</p>
                      @endif
                    <form action="{{asset('/RLS/modification-de-profil')}}" method="POST" id="formChangementDeProfil" class="mt-4">
                      @csrf
  ...
  <form action="{{asset('/RLS/profil/changer-mot-de-passe')}}" method="POST" id="formChangementMotDePasse">
    @csrf
