					...
					<div class="row">
						...
						<div class="col-md-4" style="margin-left:auto; margin-right:auto; text-align:center">
							<div id="profile-container">
								<image id="profileImage" src="<?php echo e(asset('images/photo_de_profil/default_profile_picture.jpg')); ?>" style="width: 200px; border-radius: 50%;" />
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<?php for($i = 0; $i < count($fonction); $i++): ?>
								<option value="<?php echo e($fonction[$i]->id); ?>"><?php echo e($fonction[$i]->nom); ?></option>
							<?php endfor; ?>
							</select>
						</div>
					</div>
							...
							<div class="wrap-input100 validate-input">
								<select class="input100" style="border: none;" name="id_region" onchange="showDistricts()" id="id_region" required>
									...
									<?php for($i = 0; $i < count($region); $i++): ?>
										<option value="<?php echo e($region[$i]->id); ?>"><?php echo e($region[$i]->nom); ?></option>
									<?php endfor; ?>
								</select>
								<span class="focus-input100"></span>
								<span class="symbol-input100">
...
</html><?php /**PATH D:\stage\portail\resources\views/authentification/inscription.blade.php ENDPATH**/ ?>